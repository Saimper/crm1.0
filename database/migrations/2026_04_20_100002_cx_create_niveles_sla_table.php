...
return new class extends Migration
{
    ...
    {
        Schema::create('niveles_sla', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['proyecto_id', 'codigo'], 'niveles_sla_proyecto_codigo_unique');
    ...
    {
        Schema::dropIfExists('niveles_sla');
    }
};
