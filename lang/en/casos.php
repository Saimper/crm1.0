...
return [
    ...
    // Work view redesign (2026-09): tabs, summary and form
    'tab_summary' => 'Summary',
    'tab_history' => 'History',
    'tab_fields' => 'Fields',
    ...
    'no_overdue_data' => 'No arrears data',
    'person_fisica' => 'Individual',
    'person_juridica' => 'Company',
    'edit_person' => 'Edit person',
    'use_contact' => 'Use',
    'priority_label' => 'Priority :value',
    'pending_commitment' => 'Pending commitment',
    'expires_on' => 'Due :date',
    'registered_by' => 'registered by :name',
    'see_full_record' => 'See full record',
    'recent_activity' => 'Recent activity',
    'see_full_history' => 'See full history',
    'pending_of_person' => 'Pending for this person',
    'no_pending_commitments' => 'No pending commitments.',
    'resolved_title' => 'Resolved',
    'no_resolved_commitments' => 'No resolved commitments.',
    'select_account_to_resolve' => 'Select the :entidad to resolve',
    'advisor_label' => 'Advisor',
    'commitment_promise' => 'Payment promise',
    'commitment_close' => 'Sales close',
    'commitment_resolution' => 'Resolution',
    'commitment_service' => 'Service action',
    'account_readonly_title' => 'Read-only account',
    'account_readonly_desc' => 'You can view this account. To register activity it must be assigned to you or you need the collaboration permission.',
    'pick_channel_first' => 'Pick the channel first',
    'pick_type' => 'Pick the type',
    'pick_result' => 'Pick the outcome',
    'saved_with_gestion' => 'Saved with the activity',
];
