<div>
    ...
    <div class="card" style="padding:0;">
        <div style="padding:12px 16px;border-bottom:1px solid var(--border);display:flex;gap:10px;align-items:center;">
            ...
            <span style="flex:1;"></span><span style="font-size:12px;color:var(--text-tertiary);">{{ __('configurador.niveles_escalamiento.n_niveles', ['n' => $rows->count()]) }}</span>
    ...
    @if($formVisible)
        ...
        <div class="drawer" wire:key="cat-ne-drawer">
            <div class="drawer-header"><div style="font-size:14px;font-weight:600;">{{ $editandoId === null ? __('configurador.niveles_escalamiento.drawer_nuevo') : __('configurador.niveles_escalamiento.drawer_editar') }}</div>
