<div>
    ...
    <div class="card">
        <x-ui.toolbar :count="__('configurador.estados_tecnicos.n_estados', ['n' => $rows->count()])">
    ...
    @if($formVisible)
        ...
        <div class="drawer" wire:key="cat-et-drawer">
            <div class="drawer-header"><div class="text-md font-semibold">{{ $editandoId === null ? __('configurador.estados_tecnicos.drawer_nuevo') : __('configurador.estados_tecnicos.drawer_editar') }}</div>
