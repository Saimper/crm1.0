<div>
    ...
    <div class="card">
        <x-ui.toolbar :count="__('configurador.tipos_pago.n_tipos', ['n' => $rows->count()])">
    ...
    @if($formVisible)
        ...
        <div class="drawer" wire:key="cat-tp-drawer">
            <div class="drawer-header"><div class="text-md font-semibold">{{ $editandoId === null ? __('configurador.tipos_pago.drawer_nuevo') : __('configurador.tipos_pago.drawer_editar') }}</div>
