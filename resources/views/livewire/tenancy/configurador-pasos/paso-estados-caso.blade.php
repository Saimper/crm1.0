<div>
    ...
    <div class="card" style="padding:0;">
        <div style="padding:12px 16px;border-bottom:1px solid var(--border);display:flex;gap:10px;align-items:center;">
            ...
            <span style="font-size:12px;color:var(--text-tertiary);">{{ $estados->count() }} estados</span>
        ...
        @if($estados->isEmpty())
            <div class="empty">
                ...
                <div class="empty-title">Sin estados</div>
                <div class="empty-desc">Define los estados operativos del caso (ej. Abierto, En gestión, Cerrado).</div>
            </div>
        @else
            <table class="table table-compact table-clickable">
                <thead>
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th>Descripción</th>
                        <th style="width:90px;">Terminal</th>
        ...
        <div class="drawer" wire:key="paso-estado-drawer">
            <div class="drawer-header">
                <div style="font-size:14px;font-weight:600;">
                    {{ $editandoId === null ? 'Nuevo estado' : 'Editar estado' }}
                </div>
                ...
                <div style="display:grid;grid-template-columns:1fr;gap:14px;">
                    ...
                    <div>
                        <label style="display:flex;align-items:center;gap:8px;">
                            ...
                            <span style="font-size:13px;color:var(--text-secondary);">Estado terminal (cierra el caso)</span>
                        </label>
                    </div>
                </div>
            </div>
            <div class="drawer-footer">
                @if($editandoId !== null)
                    <button type="button"
                            ...
                            wire:confirm="¿Eliminar este estado? Solo se permite si no hay casos asociados."
                            class="btn btn-ghost"
