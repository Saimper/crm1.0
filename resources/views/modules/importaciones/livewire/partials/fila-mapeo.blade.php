<tr>
    <td class="px-3 py-2 align-top">
        <div class="flex items-center gap-2">
            ...
            @if($campo->requerido)
                <span class="rounded bg-danger-50 px-1.5 py-0.5 text-[10px] font-semibold text-danger-700">requerido</span>
            @else
                <span class="rounded bg-ink-100 px-1.5 py-0.5 text-[10px] text-ink-600">opcional</span>
            @endif
        </div>
