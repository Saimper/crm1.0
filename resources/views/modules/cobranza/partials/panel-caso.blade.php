...
@if($cobranza)
    <div class="rounded-md border border-warning-200 bg-warning-50 p-4 space-y-3">
        <div class="flex items-start justify-between gap-4">
            <div>
                <div class="text-[10px] uppercase tracking-wider text-warning-700">Caso de cobranza · Préstamo</div>
                <div class="text-lg font-semibold text-warning-700 font-mono">{{ $cobranza->numero_prestamo }}</div>
            </div>
            <div class="text-right">
                <div class="text-xs uppercase tracking-wider text-warning-700 font-semibold">Saldo total</div>
